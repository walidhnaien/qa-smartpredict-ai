...
public QualityIntelligenceDto calculate(UUID releaseId) {

    CoverageSummaryDto coverage =
            coverageService.calculateCoverageSummary(releaseId);

    DefectSummaryDto defect =
            defectService.calculateDefectScore(releaseId);

    IncidentSummaryDto incident =
            incidentService.calculate(releaseId);

    RcaSummaryDto rca =
            rcaService.calculate(releaseId);
